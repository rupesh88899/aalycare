      ...
      body: ListView(
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: Image.asset('assets/images/man_health_risk_assessment.png',
          ...
          const Wrap(spacing: 12, runSpacing: 12, children: [
            _FeatureChip(
                icon: Icons.monitor_heart_outlined, label: 'Key Body Vitals'),
            _FeatureChip(
                icon: Icons.accessibility_new_outlined,
                label: 'Posture Analysis'),
            _FeatureChip(
                icon: Icons.monitor_weight_outlined, label: 'Body Composition'),
          ...
          ClipRRect(
            borderRadius: BorderRadius.circular(24),
            child: Image.asset('assets/images/posture_analysis_icon.png',
                height: 220, fit: BoxFit.cover),
          ),
          ...
          Container(
            ...
            child: const Row(children: [
              ...
              SizedBox(width: 8),
              Expanded(
                  child: Text('We do not store or share your personal data'))
            ]),
          ),
          const SizedBox(height: 16),
          const _StepList(),
